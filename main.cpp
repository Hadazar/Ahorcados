...
char* Palabra_aleotoria(istream&Categoria,char* x,int Letras){
    ...
    //Llenar a la matriz vac�a con car�cteres del dibujo.
...
int main()
{
    ...
    while (Seguir_jugando==1){
        ...
        cout<<y<<endl;
            ...
            //Selecci�n de una categor�a y una palabra al azar.
        switch (y){
        ...
        while(j<n){
            ...
            //Llenado de una matriz con los car�teres del dibujo.
        ...
        for (int i=0;i<5;i++){
            ...
            //Llenado de una matriz de igual tama�o de la anterior, pero con espacios vac�os.
        ...
        cout <<"Nivel de dificultad: ";
            ...
            //Determinaci�n del nivel de dificultad.
        char s_c;
        s_c=getch();
        cout <<s_c;
        Sleep(500);
        ...
        while (b!=n&&v<24){
            ...
            cout<<'\n';
                ...
                //Impresi�n en pantalla de las letras usadas.
            j=0;
            cout <<"Letras usadas: ";
            ...
            cout<<'\n'<<endl;
                ...
                //Conversi�n de may�sculas a min�sculas.
            if ((int)Letra>=65&&(int)Letra<=90){
                Letra=(int)Letra+32;
            };
                //Verificaci�n de que el car�cter introducido es una letra.
            ...
            getch();
                ...
                bool d=0;
                    ...
                    //comprobaci�n de que la letra introducida no hab�a sido introducida antes.
                while (c==0){
            ...
            if (b==n){
                ...
                cout<<'\n';
                    ...
                    //Impresion en pantalla de las letras usadas.
                j=0;
                cout <<"Letras usadas: ";
                while (Letras_usadas[j]!=0){
                    cout <<Letras_usadas[j]<<" ";
